                  ...
                  <div className="lg:w-1/4 md:w-1/2 p-4 w-full border border-opacity-50 mb-4 ">
                    ...
                    <div className="mt-1">
                      ...
                      <div className="max-w-sm">
                        ...
                        <button className="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" onClick={(() => { handlecard(item) })} disabled={cartId ? true : false} >{cartId ? "Added" : "Add to Card"}</button>
                      </div>
                    </div>
